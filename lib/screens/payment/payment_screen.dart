...
import 'package:afaq/screens/payment/components/cash.dart';
import 'package:afaq/screens/payment/components/visa.dart';
      ...
      return appState.currentUser != null
        ...
        child: ListView(
          children: <Widget>[
            ...
            Text("شحن وتوصيل المنتج",style: TextStyle(color: cLightRed,fontWeight: FontWeight.bold),),
            ...
            Row(
              children: [
                Text("المشتريات",style: TextStyle(color: cText,fontSize: 14),),
                Spacer(),
                Text("---------------------",style: TextStyle(color: cLightGrey,fontSize: 14),),
                Spacer(),
                Text(_appState!.currentTotal.toStringAsFixed(2),style: TextStyle(color: cLightRed,fontSize: 14,fontWeight: FontWeight.bold),),
                Padding(padding: EdgeInsets.all(2)),
                Text("ريال",style: TextStyle(color: cText,fontSize: 14),),
              ],
            ),
            SizedBox(
              height: _height*.02,
            ...
            Row(
              children: [
                Text("الشحن والتوصيل",style: TextStyle(color: cText,fontSize: 14),),
                Spacer(),
                Text("--------------------",style: TextStyle(color: cLightGrey,fontSize: 14),),
                Spacer(),
                Text(_appState!.currentTawsil.toString(),style: TextStyle(color: cLightRed,fontSize: 14,fontWeight: FontWeight.bold),),
                Padding(padding: EdgeInsets.all(2)),
                Text("ريال",style: TextStyle(color: cText,fontSize: 14),),
              ],
            ),
            ...
            _appState!.checkedValue1=="1" && _appState!.estlam! >0?Row(
              children: [
                Text("رسوم الدفع عند الاستلام",style: TextStyle(color: cText,fontSize: 14),),
                Spacer(),
                Text("-------------",style: TextStyle(color: cLightGrey,fontSize: 14),),
                Spacer(),
                Text(_appState!.estlam.toString(),style: TextStyle(color: cLightRed,fontSize: 14,fontWeight: FontWeight.bold),),
                Padding(padding: EdgeInsets.all(2)),
                Text("ريال",style: TextStyle(color: cText,fontSize: 14),),
              ],
            ):Text("",style: TextStyle(height: 0),),
            _appState!.checkedValue1=="1"  && _appState!.estlam! >0?SizedBox(
              height: _height*.02,
            ):Text("",style: TextStyle(height: 0),),

            Row(
              children: [
                Text("قيمة الضريبة",style: TextStyle(color: cText,fontSize: 14),),
                Spacer(),
                Text("----------------------",style: TextStyle(color: cLightGrey,fontSize: 14),),
                Spacer(),
        ...
        FutureBuilder<String>(
          ...
          builder: (context, snapshot) {
            ...
            Container(
              ...
              child: Row(
              children: [
                Text("إجمالى الفاتورة",style: TextStyle(color: cWhite,fontWeight: FontWeight.bold,fontSize: 17),),
                Spacer(),
                Container(
                  width: 2,
                  color: cWhite,
                ...
                Column(
                  children: [
                    Row(
                      children: [
                        _appState!.checkedValue1=="1" && _appState!.estlam! >0?Text((_appState!.currentTotal+_appState!.currentTawsil+_appState!.estlam!).toStringAsFixed(2),style: TextStyle(color: cWhite,fontWeight: FontWeight.bold,fontSize: 30),):Text((_appState!.currentTotal+_appState!.currentTawsil).toStringAsFixed(2),style: TextStyle(color: cWhite,fontWeight: FontWeight.bold,fontSize: 30),),
                        Text(" ريال ",style: TextStyle(color: cWhite,fontSize: 17),),
                      ],
                    ),

                    Text(" شامل الضريبة ",style: TextStyle(color: cWhite,fontSize: 17),),
                  ],
                )
              ],
              ),
            ...
            Container(
              child: Column(
                ...
                children: [
                  Text(" وسائل الدفع ",style: TextStyle(color: cText,fontSize: 16,fontWeight: FontWeight.bold),),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("الدفع عند الإستلام",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                            Padding(padding: EdgeInsets.all(4)),
                            Text("الدفع النقدي عند إستلام الشحنة",style: TextStyle(fontSize: 12,color: cLightGrey),),
                          ],
                        ),

                        Spacer(),
                        _appState!.checkedValue1=="1"?GestureDetector(
                          onTap: (){
                            setState(() {
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("الدفع الإلكتروني",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                            Padding(padding: EdgeInsets.all(4)),
                            Text("الدفع عن طريق VISA , Master Card",style: TextStyle(fontSize: 12,color: cLightGrey),),
                          ],
                        ),
                        Spacer(),
                        _appState!.checkedValue1=="2"?GestureDetector(
                          onTap: (){
                            setState(() {
                              _progressIndicatorState!.setIsLoading(true);
                           //   _appState!.setCheckedValue1(null);
      ...
      if(_appState!.checkedValue1=="1") {
        ...
        var response = await MyFatoorah.startPayment(
          ...
          request: MyfatoorahRequest.live(
            ...
            successUrl: "https://mahtco.net/app/site/success/${_appState!.currentUser!.userId}",
            errorUrl: "https://mahtco.net/app/site/failed/",
            invoiceAmount:_appState!.currentTotal+_appState!.currentTawsil,
            language: ApiLanguage.Arabic,


            token: "FrOQYRRHMqVaPPtl3IB7B8nSOXQHJPw8vpk1IonC4-blUYrnNOS3Whk70j9hYu7_3QqPLp16Dbutm_H5MoDsxG2pJO5lVvdG7R0jfZ9zyPN9ago5KwT76C-FkX9s4zpiqNTaeupptZVys_I1Gr6rn6pC2EPI_LRMJPkVWqemwwtrN9rWoUW7OsmLtDtHEupMR274eOoTnTkzWjZfIjjhECpFEIO8auN_xMwb66ALpx7SLzlxX0ht_7WV84WjuC8mY7v4QfDMI_LpTMzeWWNuApTC7wAqDfLPG1RoDCQcrUVq7QQz28Jb-HNO-0s-1016OXZCShpd9fFnMMu4i55gIF-ayYkL9QKhoimveRUxQbfT2KTcD50FOS0cJy3pM9C4uXJ4yXwRMeNii5XzLLgzBs83gyVhsZ8iz7s1RCshZUOuEiWWLl7v43DZeZhKYUNEe_t0XIURnraM7ZPTzE_0rdrOlj78ILQIMSkzse6MRG5GMOq7qc0LdVtWeaG2z5-Tm4HcSaPLdEAR7VzGZGuF_hKQshlRx2ET-Ezj8HNQQB0Ttkecb2RXeMDvsDXeF8rU2zj3sxabgww3HWDdm4EoBgkcgenyFUA3xSuxyQ2TuvMhzpxIBgqO6k4xjOYzot_IiUp-MA4nCSd6DeyNo3wdp1ZVA8M0Fu05Uu2U8wnaS6CBAbpY_BQbp-KU_ipp37ODXmTtuisn5TlyROJK1_m1w7uZ0Cw",
          ),
        );
