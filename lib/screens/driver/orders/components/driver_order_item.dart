    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _buildItem( "اسم العميل",
              widget.order!.carttUserName!),
          _buildItem( "العنوان",
              widget.order!.carttAdress!),
              _buildItem("تاريخ الطلب",widget.order!.carttDate!),
                 _buildItem(AppLocalizations.of(context)!.orderPrice,widget.order!.carttTotlal.toString()+" ريال "),
             ...
             widget.currentOrder! ?       Container(
               padding: (appState.currentLang=='ar')?EdgeInsets.only(right: 6):EdgeInsets.only(left: 6),
                    ...
                    child: CustomButton2(
                      ...
                      btnLbl: (widget.order!.carttState=='1')?"بدء التوصيل":"انهاء التوصيل",
               ...
               children: <Widget>[
                 ...
                 Text('( ${widget.order!.rate} )',style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    onTap: (){
                      launch(
                          "tel://00966${widget.order!.carttUserPhone}");
                    },
                  )
