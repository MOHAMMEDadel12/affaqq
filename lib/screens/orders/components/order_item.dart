    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(padding: EdgeInsets.all(3)),
              _buildItem("تاريخ الطلب",widget.order!.carttDate!),
                 _buildItem("الاجمالي",widget.order!.carttTotlal.toString()+"  ريال "),
       ...
       Row(
             ...
             widget.currentOrder && widget.order!.carttStateNumber=="0" ?       Container(
               padding: (appState.currentLang=='ar')?EdgeInsets.only(right: 6):EdgeInsets.only(left: 6),
                  ...
                  ) :  widget.order!.rate  == 0 && widget.order!.carttStateNumber=="3"  ? Container(
                    width: width *0.35,
                    height: 30,
                    child: CustomButton2(
