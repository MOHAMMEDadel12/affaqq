                             ...
                             child: Center(
                               child: RichText(
                                 text: TextSpan(
                                   ...
                                   children: <TextSpan>[
                                     TextSpan(text: (double.parse(carttDetail.carttPrice!)*carttDetail.carttAmount!).toStringAsFixed(2)),
                                     TextSpan(text: '  '),
                                     TextSpan(
                                       text: "ريال",
                                       style: TextStyle(
            ...
            children: <Widget>[
              _buildRow( "تاريخ الطلب",
               snapshot.data!.carttDate!),
                ...
                _buildRow( "اجمالي الطلب", '${snapshot.data!.carttTotlal.toString()} ريال '),

              SizedBox(height: _height*.02,),
              _buildRow( "حالة الطلب",
                  snapshot.data!.carttState!),
