...
import 'package:afaq/utils/hex_color.dart';
...
String? _sValue;
  ...
  Future<List<Type>> _getTypeItems(String x) async {
    ...
    Map<dynamic, dynamic> results = x=="0"?await _services.get(
        'https://mahtco.net/app/api/gettype?lang=${_appState!.currentLang}&marka_id=0'):await _services.get(
                ...
                return Consumer<AppState>(builder: (context, appState, child) {
                  return GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          crossAxisCount: 3, crossAxisSpacing: 1, mainAxisSpacing: 1,childAspectRatio: 3.3/5),
                         ...
                         setState(() {
                           ...
                           Navigator.push(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                          color: ColorUtils.stringToColor(snapshot.data![index].mtgerCatPhoto!),
...
leading: Text(""),
      title: Container(
        ...
        child: Text("الرئيسية",style: TextStyle(fontSize: 16),),
      ),
    );
